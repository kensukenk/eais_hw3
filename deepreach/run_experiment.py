...
if (mode == 'all') or (mode == 'train'):
    ...
    p.add_argument('--num_epochs', type=int, default=2500, help='Number of epochs to train for.')
    p.add_argument('--clip_grad', default=0.0, type=float, help='Clip gradient.')
    p.add_argument('--use_lbfgs', default=False, type=bool, help='use L-BFGS.')
    p.add_argument('--adj_rel_grads', default=False, type=bool, help='adjust the relative magnitude of the losses')
